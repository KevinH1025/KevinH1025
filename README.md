...
**[LLM Agent Benchmarking](https://github.com/kschwethelm/agentic-cdm-benchmark)**: TUM team project. We compared 8 open-source models on task success, accuracy and latency across 2400 clinical cases. I worked on the tools the model could call.
...
**Tools:** Python, PyTorch, PyTorch Geometric, LangChain, C++, ROS / ROS2, Linux, SLURM

Based in Munich. hu25kevin@gmail.com · [LinkedIn](https://www.linkedin.com/in/zhongkai-hu-5a29401b8/)
